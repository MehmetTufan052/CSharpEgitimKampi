...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgLocationPrice.Text = String.Format("{0:0.00}", db.Location.Average(x => x.LocationPrice), 2);
            ...
            lblTürkiyeAvgCapacity.Text = db.Location.Where(x => x.LocationCountry == "Türkiye").Average(y => y.LocationCapacity).ToString();
            ...
            lblMaxLocationPrize.Text = db.Location.Where(x => x.LocationPrice == maxPrice).Select(y => y.LocationCity).FirstOrDefault().ToString();
